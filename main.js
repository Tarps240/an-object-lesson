...
mySelfObj.firstName = 'Scott';

// Add a `lastName` property and set it to a string.

mySelfObj.lastName = 'Lewis';
...
mySelfObj.address.push('480 Ringgold Rd', '9840 Catalina Dr', '7169 E Sunflower ln');
...
const alexOvechkin = {
  ...
  isActive: true,        
  goals: 841,             
  awards: ["Calder", "Rocket Richard", "Art Ross", "Hart Trophy", "Stanley Cup"],  
  "Is Under Contract": true
};
